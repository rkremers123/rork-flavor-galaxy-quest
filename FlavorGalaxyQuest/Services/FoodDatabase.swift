...
struct FoodDatabase {
    static let allFoods: [FoodItem] = [
        ...
        FoodItem(name: "Popcorn", emoji: "🍿", texture: .crunchy, flavor: .salty, temperature: .roomTemp, aroma: .mild, category: .grain, planetColorHex: "FFFDD0"),
        FoodItem(name: "Tortilla Chips", emoji: "🫓", texture: .crunchy, flavor: .salty, temperature: .roomTemp, aroma: .noOdor, category: .grain, planetColorHex: "F0C75E", allergens: [.gluten]),
        FoodItem(name: "Graham Crackers", emoji: "🍪", texture: .crunchy, flavor: .sweet, temperature: .roomTemp, aroma: .mild, category: .grain, planetColorHex: "C19A6B", allergens: [.gluten]),
        FoodItem(name: "Cereal", emoji: "🥣", texture: .crunchy, flavor: .sweet, temperature: .cold, aroma: .mild, category: .grain, planetColorHex: "F5D76E", allergens: [.gluten]),
        FoodItem(name: "Granola Bar", emoji: "🍫", texture: .crunchy, flavor: .sweet, temperature: .roomTemp, aroma: .mild, category: .grain, planetColorHex: "8B6914", allergens: [.gluten, .treeNut]),
        FoodItem(name: "Cinnamon Toast", emoji: "🍞", texture: .crunchy, flavor: .sweet, temperature: .hot, aroma: .mild, category: .grain, planetColorHex: "D2691E", allergens: [.gluten, .dairy]),
        FoodItem(name: "Pancakes", emoji: "🥞", texture: .soft, flavor: .sweet, temperature: .hot, aroma: .mild, category: .grain, planetColorHex: "DEB887", allergens: [.gluten, .egg, .dairy]),
        FoodItem(name: "Waffles", emoji: "🧇", texture: .crunchy, flavor: .sweet, temperature: .hot, aroma: .mild, category: .grain, planetColorHex: "D4A574", allergens: [.gluten, .egg, .dairy]),
        FoodItem(name: "Oatmeal", emoji: "🥣", texture: .mushy, flavor: .bland, temperature: .hot, aroma: .mild, category: .grain, planetColorHex: "C8B084", allergens: [.gluten]),
        FoodItem(name: "Pizza", emoji: "🍕", texture: .mixedTexture, flavor: .salty, temperature: .hot, aroma: .strong, category: .grain, planetColorHex: "FF6347", allergens: [.gluten, .dairy]),

        FoodItem(name: "Pudding", emoji: "🍮", texture: .mushy, flavor: .sweet, temperature: .cold, aroma: .mild, category: .dairy, planetColorHex: "D2B48C", allergens: [.dairy]),
        FoodItem(name: "Applesauce", emoji: "🍎", texture: .mushy, flavor: .sweet, temperature: .cold, aroma: .mild, category: .fruit, planetColorHex: "C1876B"),
        FoodItem(name: "Mashed Potatoes", emoji: "🥔", texture: .mushy, flavor: .bland, temperature: .hot, aroma: .mild, category: .vegetable, planetColorHex: "F5F5DC", allergens: [.dairy]),
        FoodItem(name: "Mozzarella Sticks", emoji: "🧀", texture: .soft, flavor: .salty, temperature: .hot, aroma: .mild, category: .dairy, planetColorHex: "FFA500", allergens: [.dairy, .gluten]),
        FoodItem(name: "Dried Fruit", emoji: "🍇", texture: .soft, flavor: .sweet, temperature: .roomTemp, aroma: .mild, category: .fruit, planetColorHex: "8B4513"),
        FoodItem(name: "Fruit Roll-Ups", emoji: "🍬", texture: .soft, flavor: .sweet, temperature: .roomTemp, aroma: .mild, category: .fruit, planetColorHex: "FF69B4"),
        FoodItem(name: "Bacon", emoji: "🥓", texture: .crunchy, flavor: .salty, temperature: .hot, aroma: .strong, category: .protein, planetColorHex: "8B0000"),
        FoodItem(name: "Cheese Slices", emoji: "🧀", texture: .soft, flavor: .salty, temperature: .cold, aroma: .mild, category: .dairy, planetColorHex: "FFD700", allergens: [.dairy]),
        FoodItem(name: "Chicken Breast", emoji: "🍗", texture: .soft, flavor: .bland, temperature: .hot, aroma: .mild, category: .protein, planetColorHex: "F5DEB3"),
        FoodItem(name: "Taco", emoji: "🌮", texture: .crunchy, flavor: .salty, temperature: .hot, aroma: .strong, category: .protein, planetColorHex: "DAA520", allergens: [.gluten, .dairy]),
        FoodItem(name: "Grilled Cheese", emoji: "🥪", texture: .crunchy, flavor: .salty, temperature: .hot, aroma: .mild, category: .grain, planetColorHex: "FFD700", allergens: [.gluten, .dairy]),
        FoodItem(name: "Pear", emoji: "🍐", texture: .soft, flavor: .sweet, temperature: .cold, aroma: .mild, category: .fruit, planetColorHex: "9ACD32"),
        FoodItem(name: "Cherry Tomato", emoji: "🍅", texture: .soft, flavor: .sour, temperature: .roomTemp, aroma: .mild, category: .vegetable, planetColorHex: "FF6347"),
        FoodItem(name: "Hummus", emoji: "🫘", texture: .mushy, flavor: .bland, temperature: .cold, aroma: .mild, category: .protein, planetColorHex: "C8AD7F"),
        FoodItem(name: "String Cheese", emoji: "🧀", texture: .soft, flavor: .bland, temperature: .cold, aroma: .noOdor, category: .dairy, planetColorHex: "FFFFF0", allergens: [.dairy]),
        FoodItem(name: "Raisins", emoji: "🍇", texture: .soft, flavor: .sweet, temperature: .roomTemp, aroma: .mild, category: .fruit, planetColorHex: "4B0082"),
    ]
