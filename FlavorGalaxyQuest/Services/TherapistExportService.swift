...
struct TherapistExportService {
    ...
    static func generatePDFData(
        ...
        let data = pdfRenderer.pdfData { context in
            ...
            let title = "Flavor Galaxy — Sensory Progress Report"
            ...
            let footer = "This report was generated by Flavor Galaxy and is based on the SOS (Sequential Oral Sensory) Approach."
